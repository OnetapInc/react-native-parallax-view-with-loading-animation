...
var ParallaxView = React.createClass({
    ...
    renderBackground: function () {
        ...
        return (
            <Animated.Image
                style={[styles.background, {opacity: this.state.animating ? this.state.volume : 1.0}, {
                    height: windowHeight,
                    transform: [{
        ...
        return (
		    ...
		    keyboardShouldPersistTaps
                    ...
                    <TouchableWithoutFeedback onPress={() => this.props.onPress }>
                        <Animated.View
                            style={[styles.content, props.scrollableViewStyle, {opacity: this.state.animating ? this.state.volume : 1.0}]}>
                            {this.props.children}
                        </Animated.View>
                    </TouchableWithoutFeedback>
                </ScrollView>
