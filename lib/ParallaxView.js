...
var ParallaxView = React.createClass({
    ...
    render: function () {
        ...
        return (
            <View style={[styles.container, style]} onLayout={()=>{this.setState({animating: false})}}>
                ...
                <ScrollView
                    ...
                    {this.renderHeader()}
                    <Animated.View style={[styles.content, props.scrollableViewStyle]}>
                        {this.props.children}
                    </Animated.View>
                </ScrollView>
            </View>
...
var styles = StyleSheet.create({
    ...
    content: {
        ...
        shadowRadius: 2,
        backgroundColor:'#ccc',
        opacity: this.state.animating ? this.state.volume : 1.0,
        flex: 1,
